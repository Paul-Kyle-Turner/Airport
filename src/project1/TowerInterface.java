...
public interface TowerInterface {
	...
	public void addExistingPlaneIntoWaiting(Plane plane);//takes the plane and changes it to a reenter plane adding it to the reenter queue and removing it from others
