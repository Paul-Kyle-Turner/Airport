...
/**
 * Class Driver contains the code for running the application and using user input to operate the airport model through the tower class.
 * @author Paul Kyle Turner
 * @author Nicholas Weintraut(editor)
 */
public class Driver {
    ...
    static void startingRunways() {
        ...
        do {
            numRunways = getIndex("Please enter the number of starting takeoff runways: ");
            if(numRunways > 0)
        ...
        for(int i = 0; i < numRunways; i++) {
            ...
            System.out.println("Runway " + name + " was just opened as a take-off runway!\n");
            tower.createNewRunway(name, false);
        }
        numRunways = 0;
        validNumRunways = false;
        do {
            numRunways = getIndex("Please enter the number of starting landing runways: ");
            if(numRunways > 0)
                validNumRunways = true;
            else
        ...
        for(int i = 0; i < numRunways; i++) {
            ...
            System.out.println("Runway " + name + " was just opened as a landing runway!\n");
    ...
    private static void runwayOpens() throws IOException {
        ...
        System.out.print("Is this a landing Runway?(Y/N) ");
        String answer = stdin.readLine().trim().toUpperCase();
        System.out.println(answer);
        ...
        System.out.println("Runway " + name + " was just opened as a " + (landing?"landing":"takeoff") + " runway.\n");
    ...
    private static void planeLeavesTheSystem() throws IOException {
        ...
        do {
            System.out.print("Please specify if the plane has clearance to take off (Y/N): ");
            String answer = stdin.readLine().trim().toUpperCase();
            System.out.println(answer);
            if(answer.equals("Y") || answer.equals("YES")) {
    ...
    private static void planeEntersSystem() throws IOException {
        ...
        String destination = "";
        do {
            System.out.print("Is the flight landing?(Y/N): ");
            String answer = stdin.readLine().trim().toUpperCase();
            System.out.println(answer);
            if(answer.equals("N") || answer.equals("NO")) {
                ...
                unrecognized = false;
                System.out.println("Flight " + flightNumber + " to " + destination + " is waiting to take-off on runway " + runwayName);
                ...
                unrecognized = false;
                System.out.println("Flight " + flightNumber + " to " + destination + " is waiting to land on runway " + runwayName);
            }
        } while(unrecognized);
        System.out.println("");
